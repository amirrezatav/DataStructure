...
namespace DataStructureProject_1
{
    public class ParenthesisStack
    {
        ...
        private static bool CheckPriority(StackArray<char>  inputOperatorStack , char input)
        {
            StackArray<char> OperatorStack = new StackArray<char>(inputOperatorStack.Size);
            StackArray<char>.Copy(OperatorStack, inputOperatorStack);
            if (input == ')')
                return true;
        ...
        private static void SetParenthesis(ref StackArray<string> OperandStack, ref StackArray<char> OperatorStack)
        {
            while((OperatorStack.Peek()!='('))
            {
        ...
        public static string Set(string  input)
        {
            ...
            string result;
            StackArray<string> OperandStack = new StackArray<string>(input.Length);
            StackArray<char> OperatorStack = new StackArray<char>(input.Length);
