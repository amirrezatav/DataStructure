    ...
    public class ApplicationStack
    {
        ...
        void Parking(bool isTest = true)
        {
            ...
            try
            {
                ...
                ParkingSys = new CarControllerStack(Max);
            }
            catch (Exception ex)
            {
        ...
        void ColoredRingFunc()
        {
            ...
            Console.Clear();
                ...
                if (inputmode == ConsoleKey.D1 || inputmode == ConsoleKey.NumPad1)
                {
                    ...
                    while (true)
                    {
                        ColoredRingStack coloredRing = new ColoredRingStack();
                ...
                else if (inputmode == ConsoleKey.D2 || inputmode == ConsoleKey.NumPad2)
                {
                    ...
                    while (true)
                    {
                        ...
                        coloredRing = new ColoredRingStack(rings, rods);
